        ...
        {recommendations.map((product) => (
          ...
          >
            {product.imageUrl ? (
              <button
                type="button"
                className="group relative block aspect-square w-full cursor-zoom-in overflow-hidden border-0 border-b-[0.5px] border-line bg-transparent p-0"
              ...
              <div className="aspect-square overflow-hidden border-b-[0.5px] border-line">

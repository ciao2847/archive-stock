    ...
    <>
      ...
      <aside className="drawer order-drawer">
        ...
        <form onSubmit={submit}>
          ...
          <div className="mt-[26px] flex items-end justify-between [&>span]:font-mono [&>span]:text-[13px] [&>span]:font-medium [&>span]:text-[var(--color-rust)] [&_h3]:mb-1 [&_h3]:mt-0 [&_p]:m-0 [&_p]:text-[11px] [&_p]:text-[var(--color-muted)]">
            <div>
              <h3>選擇訂購商品</h3>
              <p>只顯示目前在庫的商品</p>
            </div>
          ...
          {selectedProducts.length > 0 && (
            <section className="mt-4 rounded-lg border border-[var(--color-line)] bg-[var(--color-white)] p-4">
              ...
              <div className="space-y-3">
                {selectedProducts.map((product) => (
                  <label className="flex items-center gap-3" key={product.dbId}>
                    ...
                    <input
                      className="w-24 rounded-md border border-[var(--color-line)] bg-white p-2 text-right text-[16px]"
                      type="number"
                      min="0"
              ...
              <div className="mt-4 space-y-1 border-t border-[var(--color-line)] pt-3 text-[14px]">
